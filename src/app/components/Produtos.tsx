          ...
          <div className={styles.grid}>
            {products.map((p, idx) => {
              ...
              return (
                ...
                >
                  {/* Shell visual do card — agrupa card + painéis expansíveis */}
                  <div className={`${styles.cardShell} ${isOpen ? styles.cardShellOpen : ""} ${isSimOpen ? styles.cardShellSimOpen : ""}`}>
                      ...
                      <div className={styles.actions}>
                        ...
                        {p.cta ? (
                          ...
                          <button
                            ...
                            className={`${styles.btnSecondary} ${isOpen ? styles.btnSecondaryActive : ""}`}
                          >
                            {isOpen ? (
                              <>
                                Fechar
                    ...
                    {/* Detalhes expansíveis — dentro do shell para parecer parte do card */}
                    ...
                    {/* ── PAINEL SIMULAÇÃO — dentro do shell ── */}
