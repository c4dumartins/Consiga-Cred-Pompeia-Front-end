...
const products: Product[] = [
  {
    ...
    desc:
      "Antecipe seu FGTS sem comprometimento mensal, sem consulta ao SPC e Serasa, com atendimento ágil e 100% online.",
  ...
  },
  {
    ...
    desc:
      "Empréstimo exclusivo para trabalhadores com carteira assinada, com desconto direto na folha de pagamento.",
  ...
  },
  {
    ...
    desc:
      "Crédito pessoal vinculado à sua conta de energia. Receba até R$ 4.000,00 e parcele em até 24 meses.",
    image: "/energia.png",
    more: {
      intro: [
  ...
  },
  {
    ...
    desc:
      "Transforme o limite do seu cartão em dinheiro, em poucos minutos, para usar como quiser.",
    image: "/cartao.png",
    more: {
      intro: [
  ...
  },
  {
    ...
    desc:
      "Vai comprar o seu tão sonhado carro? Essa é a opção ideal para você. Financiamos até 100% do valor da tabela.",
    image: "/veiculo.png",
      more: {
      intro: [
  ...
  },
  {
    ...
    desc:
      "Seu veículo está quitado? Use-o como garantia, resgate dinheiro e aproveite como quiser.",
    image: "/garantia.png",
    more: {
      intro: [
...
export default function Produtos() {
  ...
  return (
    <div className={styles.container}>
      ...
      <h2 className={styles.heading}>Nossos Produtos</h2>
