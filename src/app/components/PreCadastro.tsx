...
import { FaUserPlus, FaCheckCircle, FaArrowRight, FaArrowLeft, FaExclamationCircle } from "react-icons/fa";

interface FormData {
  nome: string; cpf: string; dataNascimento: string; telefone: string; email: string;
  cep: string; logradouro: string; numero: string; complemento: string;
  bairro: string; cidade: string; estado: string;
  tipoConsorcio: string; valorDesejado: string; prazo: string;
...
// ── URL da API — mesma do backend de feedbacks (porta 3001) ──
...
export default function PreCadastro() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Chama POST /precadastro no mesmo backend de feedbacks (porta 3001)
      ...
      <div className={styles.page}>
        <div className={styles.successContainer}>
          ...
          <p className={styles.successText}>
            ...
            Você receberá um <strong>e-mail de confirmação</strong> em breve, e nossa equipe
            entrará em contato pelo telefone ou e-mail informado.
          </p>
          <a
            href="https://api.whatsapp.com/send?phone=5514998471839&text=Ol%C3%A1!%20Acabei%20de%20preencher%20o%20pr%C3%A9-cadastro%20e%20gostaria%20de%20saber%20mais."
            target="_blank"
    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          <div className={styles.iconWrapper}><FaUserPlus /></div>
                ...
                <div className={styles.grid2}>
                  <div className={styles.fieldGroup}>
                    ...
                    <input className={styles.input} type="text" name="cep" value={form.cep}
                      onChange={handleChange} placeholder="00000-000" required />
                  </div>
                  <div className={styles.fieldGroup}>
              ...
              <div className={styles.formStep}>
                ...
                <div className={styles.grid2}>
                  <div className={styles.fieldGroup}>
                    ...
                    <select className={styles.input} name="tipoConsorcio" value={form.tipoConsorcio}
                      onChange={handleChange} required>
                      <option value="">Selecione</option>
                      ...
                      <option value="Empréstimo com Débito na Conta de Energia">Empréstimo - Conta de Energia</option>
                      <option value="Empréstimo no Cartão de Crédito">Empréstimo no Cartão</option>
                  ...
                  <div className={styles.fieldGroup}>
                    ...
                    <select className={styles.input} name="valorDesejado" value={form.valorDesejado}
                      onChange={handleChange} required>
                      <option value="">Selecione</option>
                  ...
                  <div className={styles.fieldGroup}>
                    ...
                    <select className={styles.input} name="prazo" value={form.prazo}
                      onChange={handleChange} required>
                      <option value="">Selecione</option>
                  ...
                  <div className={`${styles.fieldGroup} ${styles.colSpan2}`}>
                    ...
                    <textarea className={`${styles.input} ${styles.textarea}`} name="mensagem"
                      value={form.mensagem} onChange={handleChange}
                      placeholder="Conte-nos mais sobre o que você está buscando..." rows={4} />
                  </div>
                </div>
